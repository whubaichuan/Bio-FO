...
print('CIFAR10_PEPITA')
layers = [3072, 1024,1024,1024]
classes = 10
epoch_set = 100
...
#valid_size = 5000
#train_size = len(trainset) - valid_size # 20% validation data
#trainset, validset = torch.utils.data.random_split(trainset, [train_size, valid_size])

trainloader = torch.utils.data.DataLoader(trainset, batch_size=batch_size,
                                          shuffle=True)

#valloader = torch.utils.data.DataLoader(validset, batch_size=valid_size,shuffle=True)
