...
def main():
    ...
    parser.add_argument('--test-batch-size', type=int, default=100, help='Input batch size for testing Default: 1000.')
    parser.add_argument('--lr', type=float, default=1e-4, help='Learning rate. Default: 1e-4.')
    # Network
    parser.add_argument('--topology', type=str, default='FC_1000_FC_1000_FC_1000_FC_1000_FC_100', help='Choice of network topology. Format for convolutional layers: CONV_{output channels}_{kernel size}_{stride}_{padding}. Format for fully-connected layers: FC_{output units}.')
