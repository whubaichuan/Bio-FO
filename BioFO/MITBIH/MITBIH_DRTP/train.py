...
def train(args, device, train_loader, traintest_loader, test_loader):
    ...
    for trial in range(1,args.trials+1):
        ...
        store_num = 6 #chbmit, cifar10, cifar100:5, mnist, mitbih:6
        error_mnist = np.zeros((2,store_num*100))
        gap=146  #chbmit:10, mnist, cifar10, cifar100:100, mitbih:146
        ...
        np.save(os.path.split(os.path.realpath(__file__))[0]+"/error_mitbih_drtp.npy",error_mnist)
