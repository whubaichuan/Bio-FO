...
#fixed_weights = torch.randn((10,2000))

matrix = np.zeros((10,2000))
...
for layer_index in range(layers):
    ...
    print('normal weight and zero bias')
    #print('kaiming weight and randn bias')
    #print('kaiming weight and zero bias')
    #print('kaiming normal weight and radn bias')
    #print('kaiming normal weight and zero bias')
    #print('random projection')
    #new_model.lastfc.weight.data = fixed_weights

    new_model.lastfc.weight.data = torch.randn((10,2000))
    new_model.lastfc.bias.data = torch.zeros((10))
    #new_model.lastfc.bias.data = torch.randn((10))
